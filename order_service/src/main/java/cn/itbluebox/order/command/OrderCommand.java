...
public class OrderCommand extends HystrixCommand<TbProduct> {
    ...
    @Override
    protected TbProduct run() throws Exception {
        System.out.println(Thread.currentThread().getName());
        return restTemplate.getForObject("http://127.0.0.1:9001/product/" + id, TbProduct.class);
    }
     ...
     */
    @Override
    protected TbProduct getFallback() {
